...
String adjective = JOptionPane.showInputDialog("User please enter an adjective.");
		// Get the player to enter a type of liquid
String typeOfLiquid = JOptionPane.showInputDialog("User please enter a type of liquid.");
		// Get the player to enter a body part
String bodyPart = JOptionPane.showInputDialog("User please enter a body part.");
		// Get the player to enter a verb
String verb = JOptionPane.showInputDialog("User please enter a verb.");
		// Get the player to enter a place
String place = JOptionPane.showInputDialog("User please enter a place.");
